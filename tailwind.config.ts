  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        chat: {
          me: "hsl(var(--chat-bubble-me))",
          "me-foreground": "hsl(var(--chat-bubble-me-foreground))",
          other: "hsl(var(--chat-bubble-other))",
          "other-foreground": "hsl(var(--chat-bubble-other-foreground))",
          money: "hsl(var(--chat-bubble-money))",
          "money-foreground": "hsl(var(--chat-bubble-money-foreground))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
